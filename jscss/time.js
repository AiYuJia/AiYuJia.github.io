function showTime() { 
	...
	var startDate = new Date(2017, 9, 05);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear XiaoPang:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----DaPang   2018-07-24</c>"; 
